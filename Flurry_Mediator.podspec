...
s.author       = "Team"
s.platform     = :ios, "8.0"
s.source       = {:git => 'https://bitbucket.org/vdopia/sdkdistribution.git',:tag => '4.1.5'}
...
s.vendored_libraries = "libFlurryMediator.a"
s.dependency 'Chocolate_SDK', '~> 1.0.0'
s.dependency 'Flurry-iOS-SDK/FlurrySDK', '~> 8.3.1'
s.dependency 'Flurry-iOS-SDK/FlurryAds', '~> 8.3.1'
s.requires_arc = true
end
